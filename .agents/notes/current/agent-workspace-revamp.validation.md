...
- An isolated install from a conventional local clone discovered and linked all 44 skills, including `agent-workspace`, `agent-notes`, `work-intake`, `plan`, `build-plan`, `work-closeout`, and `cursor-project-path-migration`.
...
- Public-name simplification is intentionally deferred to the proposed post-migration naming review.
