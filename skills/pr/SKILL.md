...
Closes [PLTFRM-123: Issue Title](https://linear.app/<org>/issue/PLTFRM-123/issue-slug)
...
Closes [PLTFRM-123: Add JWT validation](https://linear.app/<org>/issue/PLTFRM-123/add-jwt-validation)
```
