...
- Slack's GitHub app rewrites pasted GitHub URLs into `#123`. In Slack drafts, put each full URL in inline code so it stays visible as a URL, e.g. `` `https://github.com/cloudwalk/cw-oneclick-iac/pull/682` ``.
